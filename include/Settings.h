...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        cv::Mat cameraFov1DistortionCoef() {return cv::Mat(vPinHoleFovDistorsion1_.size(),1,CV_32F,vPinHoleFovDistorsion1_.data());}
        cv::Mat cameraFov2DistortionCoef() {return cv::Mat(vPinHoleFovDistorsion2_.size(),1,CV_32F,vPinHoleFovDistorsion1_.data());}
    ...
    private:
        ...
        std::vector<float> vPinHoleFovDistorsion1_, vPinHoleFovDistorsion2_;
